...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      @NonNull TextView headText, @NonNull LinearLayout li, @NonNull RelativeLayout main,
      @NonNull ImageButton navDrawerButton, @NonNull NavigationView navView,
      @NonNull RecyclerView recyclerViewHistory) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((DrawerLayout) rootView, drawerLayout, headText, li, main,
          navDrawerButton, navView, recyclerViewHistory);
    }
