...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull RelativeLayout rootView, @NonNull TextView navHeaderUsername) {
    this.rootView = rootView;
    this.navHeaderUsername = navHeaderUsername;
  }
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.nav_header_username;
      TextView navHeaderUsername = ViewBindings.findChildViewById(rootView, id);
      if (navHeaderUsername == null) {
        break missingId;
      }

      return new NavHeaderBinding((RelativeLayout) rootView, navHeaderUsername);
    }
